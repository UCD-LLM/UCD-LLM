...
if __name__ == "__main__":
    ...
    output_file = "ideal_eval_results.jsonl"
    ...
    with open(output_file, "a", encoding="utf-8") as out_f:
        for i in range(1,61):
            ...
            # Read Qwen_UCD data
            Qwen_UCD_file = f"../../output/Qwen-UCDLLM/{i}_result.json"
            with open(Qwen_UCD_file, "r") as f2:
                data_Qwen_UCD = json.load(f2)
            print("Successfully imported Qwen_UCD data")

            # Read Qwen_single data
            Qwen_single_file = f"../../baseline/Qwen_single/{i}_result.json"
            with open(Qwen_single_file, "r") as f3:
                data_Qwen_single = json.load(f3)
            print("Successfully imported Qwen_single data")

            # Read DeepSeek_UCD data
            DeepSeek_UCD_file = f"../../output/DeepSeek-UCDLLM/{i}_result.json"
            with open(DeepSeek_UCD_file, "r") as f4:
                data_DeepSeek_UCD = json.load(f4)
            print("Successfully imported DeepSeek_UCD data")

            # Read DeepSeek_single data
            DeepSeek_single_file = f"../../baseline/DeepSeek_single/{i}_result.json"
            with open(DeepSeek_single_file, "r") as f5:
                data_DeepSeek_single = json.load(f5)
            print("Successfully imported DeepSeek_single data")

            # Read GLM_UCD data
            GLM_UCD_file = f"../../output/GLM-UCDLLM/{i}_result.json"
            with open(GLM_UCD_file, "r") as f6:
                data_GLM_UCD = json.load(f6)
            print("Successfully imported GLM_UCD data")

            # Read GLM_single data
            GLM_single_file = f"../../baseline/GLM_single/{i}_result.json"
            with open(GLM_single_file, "r") as f7:
                data_GLM_single = json.load(f7)
            print("Successfully imported GLM_single data")

            # # Read IT4RE data
            # IT4RE_file = f"../../baseline/IT4RE/{i}_result.json"
            # with open(IT4RE_file, "r") as f8:
            #     data_IT4RE = json.load(f8)
            # print("Successfully imported IT4RE data")

            print("Using standard kg as reference")

            evaluator = KGEvaluator(data_clean, data_Qwen_UCD)
            results_Qwen_UCD = evaluator.evaluate()
            print("Evaluating Qwen_UCD")
            print(f"Entity Recall: {results_Qwen_UCD['entity_recall']}")
            print(f"Entity Precision: {results_Qwen_UCD['entity_precision']}")
            print(f"Entity F1: {results_Qwen_UCD['entity_F1']}")
            print(f"Relation Recall: {results_Qwen_UCD['relation_recall']}")
            print(f"Relation Precision: {results_Qwen_UCD['relation_precision']}")
            print(f"Relation F1: {results_Qwen_UCD['relation_F1']}")
            # print(f"Relation Similarity: {results_Qwen_UCD['relation_similarity']}")

            evaluator = KGEvaluator(data_clean, data_Qwen_single)
            results_Qwen_single = evaluator.evaluate()
            print("Evaluating Qwen_single")
            print(f"Entity Recall: {results_Qwen_single['entity_recall']}")
            print(f"Entity Precision: {results_Qwen_single['entity_precision']}")
            print(f"Entity F1: {results_Qwen_single['entity_F1']}")
            print(f"Relation Recall: {results_Qwen_single['relation_recall']}")
            print(f"Relation Precision: {results_Qwen_single['relation_precision']}")
            print(f"Relation F1: {results_Qwen_single['relation_F1']}")
            # print(f"Relation Similarity: {results_Qwen_single['relation_similarity']}")

            evaluator = KGEvaluator(data_clean, data_DeepSeek_UCD)
            results_DeepSeek_UCD = evaluator.evaluate()
            print("Evaluating DeepSeek_UCD")
            print(f"Entity Recall: {results_DeepSeek_UCD['entity_recall']}")
            print(f"Entity Precision: {results_DeepSeek_UCD['entity_precision']}")
            print(f"Entity F1: {results_DeepSeek_UCD['entity_F1']}")
            print(f"Relation Recall: {results_DeepSeek_UCD['relation_recall']}")
            print(f"Relation Precision: {results_DeepSeek_UCD['relation_precision']}")
            print(f"Relation F1: {results_DeepSeek_UCD['relation_F1']}")
            # print(f"Relation Similarity: {results_DeepSeek_UCD['relation_similarity']}")

            evaluator = KGEvaluator(data_clean, data_DeepSeek_single)
            results_DeepSeek_single = evaluator.evaluate()
            print("Evaluating DeepSeek_single")
            print(f"Entity Recall: {results_DeepSeek_single['entity_recall']}")
            print(f"Entity Precision: {results_DeepSeek_single['entity_precision']}")
            print(f"Entity F1: {results_DeepSeek_single['entity_F1']}")
            print(f"Relation Recall: {results_DeepSeek_single['relation_recall']}")
            print(f"Relation Precision: {results_DeepSeek_single['relation_precision']}")
            print(f"Relation F1: {results_DeepSeek_single['relation_F1']}")
            # print(f"Relation Similarity: {results_DeepSeek_single['relation_similarity']}")

            evaluator = KGEvaluator(data_clean, data_GLM_UCD)
            results_GLM_UCD = evaluator.evaluate()
            print("Evaluating GLM_UCD")
            print(f"Entity Recall: {results_GLM_UCD['entity_recall']}")
            print(f"Entity Precision: {results_GLM_UCD['entity_precision']}")
            print(f"Entity F1: {results_GLM_UCD['entity_F1']}")
            print(f"Relation Recall: {results_GLM_UCD['relation_recall']}")
            print(f"Relation Precision: {results_GLM_UCD['relation_precision']}")
            print(f"Relation F1: {results_GLM_UCD['relation_F1']}")
            # print(f"Relation Similarity: {results_GLM_UCD['relation_similarity']}")

            evaluator = KGEvaluator(data_clean, data_GLM_single)
            results_GLM_single = evaluator.evaluate()
            print("Evaluating GLM_single")
            print(f"Entity Recall: {results_GLM_single['entity_recall']}")
            print(f"Entity Precision: {results_GLM_single['entity_precision']}")
            print(f"Entity F1: {results_GLM_single['entity_F1']}")
            print(f"Relation Recall: {results_GLM_single['relation_recall']}")
            print(f"Relation Precision: {results_GLM_single['relation_precision']}")
            print(f"Relation F1: {results_GLM_single['relation_F1']}")
            # print(f"Relation Similarity: {results_GLM_single['relation_similarity']}")

            # evaluator = KGEvaluator(data_clean, data_IT4RE)
            # results_IT4RE = evaluator.evaluate()
            # print("Evaluating IT4RE")
            # print(f"Entity Recall: {results_IT4RE['entity_recall']}")
            # print(f"Entity Precision: {results_IT4RE['entity_precision']}")
            # print(f"Entity F1: {results_IT4RE['entity_F1']}")
            # print(f"Relation Similarity: {results_IT4RE['relation_similarity']}")
            ...
            out_data = {
                "data_id": i,
                "Qwen_UCD": {
                    "Entity Recall": results_Qwen_UCD["entity_recall"],
                    "Entity Precision": results_Qwen_UCD["entity_precision"],
                    "Entity F1": results_Qwen_UCD["entity_F1"],
                    "Relation Recall": results_Qwen_UCD["relation_recall"],
                    "Relation Precision": results_Qwen_UCD["relation_precision"],
                    "Relation F1": results_Qwen_UCD["relation_F1"],
                    # "Relation Similarity": results_Qwen_UCD["relation_similarity"]
                },
                "Qwen_single":{
                    "Entity Recall": results_Qwen_single["entity_recall"],
                    "Entity Precision": results_Qwen_single["entity_precision"],
                    "Entity F1": results_Qwen_single["entity_F1"],
                    "Relation Recall": results_Qwen_single["relation_recall"],
                    "Relation Precision": results_Qwen_single["relation_precision"],
                    "Relation F1": results_Qwen_single["relation_F1"],
                    # "Relation Similarity": results_Qwen_single["relation_similarity"]
                },
                "DeepSeek_UCD": {
                    "Entity Recall": results_DeepSeek_UCD["entity_recall"],
                    "Entity Precision": results_DeepSeek_UCD["entity_precision"],
                    "Entity F1": results_DeepSeek_UCD["entity_F1"],
                    "Relation Recall": results_DeepSeek_UCD["relation_recall"],
                    "Relation Precision": results_DeepSeek_UCD["relation_precision"],
                    "Relation F1": results_DeepSeek_UCD["relation_F1"],
                    # "Relation Similarity": results_DeepSeek_UCD["relation_similarity"]
                },
                "DeepSeek_single": {
                    "Entity Recall": results_DeepSeek_single["entity_recall"],
                    "Entity Precision": results_DeepSeek_single["entity_precision"],
                    "Entity F1": results_DeepSeek_single["entity_F1"],
                    "Relation Recall": results_DeepSeek_single["relation_recall"],
                    "Relation Precision": results_DeepSeek_single["relation_precision"],
                    "Relation F1": results_DeepSeek_single["relation_F1"],
                    # "Relation Similarity": results_DeepSeek_single["relation_similarity"]
                },
                "GLM_UCD": {
                    "Entity Recall": results_GLM_UCD["entity_recall"],
                    "Entity Precision": results_GLM_UCD["entity_precision"],
                    "Entity F1": results_GLM_UCD["entity_F1"],
                    "Relation Recall": results_GLM_UCD["relation_recall"],
                    "Relation Precision": results_GLM_UCD["relation_precision"],
                    "Relation F1": results_GLM_UCD["relation_F1"],
                    # "Relation Similarity": results_GLM_UCD["relation_similarity"]
                },
                "GLM_single": {
                    "Entity Recall": results_GLM_single["entity_recall"],
                    "Entity Precision": results_GLM_single["entity_precision"],
                    "Entity F1": results_GLM_single["entity_F1"],
                    "Relation Recall": results_GLM_single["relation_recall"],
                    "Relation Precision": results_GLM_single["relation_precision"],
                    "Relation F1": results_GLM_single["relation_F1"],
                    # "Relation Similarity": results_GLM_single["relation_similarity"]
                },
                # "IT4RE": {
                #     "Entity Recall": results_IT4RE["entity_recall"],
                #     "Entity Precision": results_IT4RE["entity_precision"],
                #     "Entity F1": results_IT4RE["entity_F1"],
                #     "Relation Similarity": results_IT4RE["relation_similarity"]
                # },
            }
